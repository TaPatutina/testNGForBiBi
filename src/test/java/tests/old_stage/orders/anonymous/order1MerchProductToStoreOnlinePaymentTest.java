...
public class order1MerchProductToStoreOnlinePaymentTest {
    WebDriver driver;
    ...
    public void orderMerchProductToStoreOnlinePayment () throws InterruptedException {
        try {
            ...
            Thread.sleep(100);
            System.out.println("order1MerchProductToStoreOnlinePaymentTest: Заказать 1 неассортиментный товар с доставкой в магазин, аноним, онлайн оплата = ОК");
