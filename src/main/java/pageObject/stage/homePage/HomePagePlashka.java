package pageObject.stage.homePage;
...
public class HomePagePlashka {
    private WebDriver driver;




    @FindBy(xpath = "//*[@data-js='region, sliderPanel']//*[contains(text(),'Да, верно')]") private WebElement agree_with_the_city_btn;
    @FindBy(xpath = "//*[@class='col-12 col-sm-6 pb-20 pb-sm-0']/div[@class='h5']") private WebElement region_request_text;
    @FindBy(xpath = "//*[@class='region-panel fade show']") private List<WebElement> elements_of_plashka;
    @FindBy(xpath = "//*[@class='region-panel fade show']//div[@class='small']") private WebElement annotation_region_request;
    @FindBy(xpath = "//*[@class='region-panel__link h6 mb-0 js-region-link js-close-panel']") private WebElement choose_another_region_btn;
    @FindBy(xpath = "//*[@class='iconed-links__item iconed-links__item--row']") private WebElement change_region_btn;
    ...
    @FindBy(xpath = "//*[@class='modal-title h2']") private WebElement popup_location_title_text;
    ...
    //согласиться с городом //hpPlashka.clickAgreeWithTheCityIndex();
    public void clickAgreeWithTheCityIndex() { agree_with_the_city_btn.click(); }
    //плашка закрылась //Assert.assertFalse(hpPlashka.isPanelOpenedIndex());
    public boolean isPanelOpenedIndex() { return agree_with_the_city_btn.getText().contains("Да, верно");  }
    ...
    public void clickAgreeWithTheCity() { agree_with_the_city_btn.click(); }
    //плашка закрылась
    ...
    public void clickChooseAnotherRegionBtn(){choose_another_region_btn.click();}
